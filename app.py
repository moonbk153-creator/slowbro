...
# ==========================================
# 2. 엑셀 기준표 로드 (공지사항은 이제 DB에서 처리)
# ==========================================
@st.cache_data
def load_target_data():
    try:
        # 엑셀에서는 순수하게 C열, D열만 읽어옵니다.
...
# [핵심 로직] DB에서 오늘 날짜에 해당하는 유효한 공지사항만 긁어옵니다.
...
# ---------------------------------------------------------
# [알림 기능] 선택한 제품에 DB에 저장된 유효한 공지사항이 있다면 띄워줌
# ---------------------------------------------------------
...
with st.expander("🛠️ 관리자 전용 메뉴 (데이터 수정/삭제 및 관리)"):
    ...
    if input_password == ADMIN_PASSWORD:
        ...
        # [신규] 탭을 4개로 확장하여 공지사항 관리 탭을 추가했습니다.
