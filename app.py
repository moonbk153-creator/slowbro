...
def load_from_db():
    ...
    # 과거 기록의 공백과 결측치(nan)를 완벽히 통일 및 정리
...
# [수정 (에러 원인 해결)] 변수를 조건문 밖에서 먼저 빈 값으로 선언하거나 즉시 정의하여 에러 차단
filter_date_str = ""
with col_filter3:
