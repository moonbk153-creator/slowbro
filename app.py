...
# [보안] Streamlit Secrets에서 암호를 불러옵니다. (GitHub 노출 방지)
ADMIN_PASSWORD = st.secrets["ADMIN_PASSWORD"]
ACCESS_PASSWORD = st.secrets["APP_PASSWORD"]

# ==========================================
# [보안] 공장 직원용 공용 접속 비밀번호 설정
# ==========================================
...
# [수정] 사이드바 생산일 선택 기본값도 한국 시간의 오늘로 설정
...
# [수정] 프로그램 실행 시마다 한국 시간 기준 '오늘'을 다시 계산하여 자동 반영합니다.
...
# 5. 화면 구성: 관리자 도구
# ==========================================
with st.expander("🛠️ 관리자 전용 메뉴 (데이터 수정/삭제 및 과거 자료 업로드)"):
                    ...
                    try:
                        ...
                        if all(col in df_upload.columns for col in required_cols):
                            ...
                            for index, row in df_upload.iterrows():
                                ...
                                # 과거 기록 업로드 시에도 한국 시간으로 변환된 현재 시각이 '입력일시'로 들어갑니다.
